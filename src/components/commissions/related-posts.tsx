...
export function CommissionRelatedPosts({ posts, commissionTitle }: Props) {
    ...
    return (
      <div className="text-center py-12">
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Ainda não há notícias publicadas para a {commissionTitle}.
        </p>
      </div>
    )
  }
        ...
        {posts.map((post) => {
          ...
          return (
            ...
            >
              ...
              <div className="p-5">
                <h4 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2 line-clamp-2 group-hover:text-[#0066cc] dark:group-hover:text-blue-400 transition-colors">
                  {post.title}
                </h4>
