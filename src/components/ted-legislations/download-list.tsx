...
import { TedLegislationDownloadCard } from './download-card'
import { TedLegislationsPagination, itemsPerPage } from './pagination'
import type { LegislationsTed } from '@/payload-types'

interface TedLegislationDownloadListProps {
  legislations: LegislationsTed[]
  onDownload?: (fileUrl: string) => void
}

export function TedLegislationDownloadList({
  legislations,
  onDownload,
}: TedLegislationDownloadListProps) {
