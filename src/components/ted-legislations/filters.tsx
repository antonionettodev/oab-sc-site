...
import type { LegislationsTedType } from '@/payload-types'

interface TedLegislationsFiltersProps {
  currentSearch: string
  currentType: string
  types: LegislationsTedType[]
}

export function TedLegislationsFilters({
  currentSearch,
  currentType,
  types,
}: TedLegislationsFiltersProps) {
  ...
  useEffect(() => {
    ...
    startTransition(() => {
      router.push(`/ted-legislacoes?${params.toString()}`, { scroll: false })
    })
